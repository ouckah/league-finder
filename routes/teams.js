...
router.route('/:id')
	.get(async (req, res) => {
		...
		res.render('teams/team', { team: team, joinable: joinable, leavable: leavable, members: members, isowner: isowner, owner: owner, messages: messages, ismember: ismember, title: team.title});
	})
